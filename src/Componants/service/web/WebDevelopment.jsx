...
export default function WebDevelopment() {
  ...
  return (
    <>
      ...
      <div className="container">
        <div className="web">
          ...
          <div className="row ">
            ...
            <div className="col-lg-4 my-3">
              <div className="box">
                <h5>Front and Back-end Development</h5>
      ...
      <div className="eng">
          <h2>Engage with Premier Web Development Experts for Your Project</h2>
          <center><hr /></center>
            ...
            <div className="row">
              ...
              <div className="col-lg-3 my-5">
                <div className="box">
                  ...
                  <p>We offer end-to-end web application <br /> development and mobile app services, encompassing design, integration, and maintenance. Our solutions focus on developing fast-loading, scalable, and secure apps compatible with all devices and platforms.</p>
                </div>
              </div>
            </div>
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-lg-4">
            <img className='benifits-img' src="./image/webdevlopment/image 116.png" alt="" />
          </div>
        </div>
      ...
      <div className="data">
        <div className="container">
          ...
          <Process 
            ...
            number2="04"
            title2="Testing"
            img2="./image/webdevlopment/Mask group (5).png"
